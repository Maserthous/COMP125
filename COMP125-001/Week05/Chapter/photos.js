...
var figureCount = 3;
//add variable for number of favorites
...
function populateFigures() {
   ...
   if (figureCount === 3) {
      for (var i = 1; i < 4; i++) {
         ...
         currentFig.src = filename;//shows the pic
      }
   } else {
      for (var i = 0; i < 5; i++) {
         filename = "images/IMG_0" + photoOrder[i] + "sm.jpg";
...
//   articleEl.appendChild(lastFigure);
   ...
   if (numberButton.addEventListener) {
    ...
    //if you add extra img at the top of the page this code doesn't work properly.
    //so add it as background-image to a container and then code should work fine.
